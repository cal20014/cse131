...
# Help references: Brother Godderidge, https://docs.python.org/3/library/json.html,
# Doc string style help comes from previous semester help from Brother Helfrich, and Brother Barzee.
...
def play_game(board):
    ...
    while True:
        ...
        current_turn = X if is_x_turn(board) else O
